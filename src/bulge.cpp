...
double bulge(double akp, double amlt) {
    // Calculates the plasmapause location in earth radii
    // for a given Kp and MLT value.
    // Algorithm taken from the GCPM plasma model, v 2.4.
    // ('bulge.for')
    // Sorry for the unreadable Fortran variable names, I just copy/pasted
    const double ahour_rad = 0.26179939;
    const double ahrrad = 2.6179939e-1;

    double centroid, along,salong,b1,b2,b3,b4,b5, x, absx;
    double a8;
